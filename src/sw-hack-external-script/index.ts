declare const installButton: HTMLButtonElement;
declare const uninstallButton: HTMLButtonElement;
declare const retrieveDataButton: HTMLButtonElement;
...
async function retrieveData() {
    let lib: typeof import('./externalLib.js');
    // @ts-expect-error 
